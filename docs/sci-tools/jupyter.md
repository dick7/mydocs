...
and below:
~~
Use [nvm](https://github.com/nvm-sh/nvm#install--update-script) to install node.js
```
...
# xelatex on the server can be customized (e.g., to use pdflatex instead)
...
# c.NotebookApp.password = u'sha1:51c5b27e9dd0:4aa6d770394976760b88936f6a3044168cbfb565'
c.NotebookApp.password = u'sha1:bb4caf78bfd5:cffcff947961bb4978c388689c77fe6cc838f4f4'
...
#c.LabApp.app_dir = '/root/anaconda3/share/jupyter/lab'
